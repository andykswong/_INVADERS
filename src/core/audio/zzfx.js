 ...
 */
export const zzfxP = (zzfxX, ...t) => {let e=zzfxX.createBufferSource(),f=zzfxX.createBuffer(t.length,t[0].length,zzfxR);t.map((d,i)=>f.getChannelData(i).set(d)),e.buffer=f;return e}
 ...
 * @returns {AudioBufferSourceNode}
 */
export const zzfx = (zzfxX, ...t) => zzfxP(zzfxX, zzfxG(...t));
