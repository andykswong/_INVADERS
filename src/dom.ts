...
export const coilBtn = document.getElementsByTagName('a')[1];
export const beginnerBtn = document.getElementsByTagName('a')[2];
export const hitOverlay = document.getElementsByTagName('b')[0];
export const crosshair = document.getElementsByTagName('span')[0];
export const screenshotBtn = document.getElementsByTagName('p')[0];
export const scoreText = document.getElementsByTagName('p')[1];
export const health = document.getElementsByTagName('p')[2];
